            ...
            <div className="bg-gradient-to-t from-black/70 via-black/40 to-transparent backdrop-blur-[2px] px-2 sm:px-3 pb-1.5 sm:pb-2.5 pt-0.5 sm:pt-1">
              <div className="flex items-center justify-between gap-0.5 sm:gap-1.5">
                ...
                <div className="flex items-center gap-0 sm:gap-0.5">
                  ...
                  {/* Fullscreen Toggle Button - SIMPLIFIED for Android native reliability */}
                  <Button 
                    variant="ghost" 
                    size="icon"
                    disabled={isFullscreenTransitioning}
                    onClick={() => {
                      console.log('[VideoPlayer] Fullscreen button clicked');
                      if (!isFullscreenTransitioning) {
                        toggleFullscreen();
                      }
                    }}
                    className={`h-8 w-8 sm:h-7 sm:w-7 text-white/90 hover:bg-white/10 active:bg-white/20 ${
...
// Export as ShakaPlayer for the wrapper component
export { VideoPlayer as ShakaPlayer };
